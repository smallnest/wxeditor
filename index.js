...
(function () {
  ...
  function getCodeThemeHref(themeName) {
    return `https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@${HLJS_VERSION}/build/styles/${themeName}.min.css`;
  }
  ...
  function applyCodeTheme(themeName) {
    ...
    if (link) link.href = getCodeThemeHref(nextTheme);
    const sel = document.getElementById('code-theme-select');
